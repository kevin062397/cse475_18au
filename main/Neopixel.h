...
class Neopixel
{
  private:
	...
	// ---- Custom Light Gestures ----
	/*
	static bool startle(uint32_t dt);
	static bool ambient1(uint32_t dt);
	static bool ambient2(uint32_t dt);
	static bool ambient3(uint32_t dt);
	static bool active1(uint32_t dt);
	static bool active2(uint32_t dt);
	static bool active3(uint32_t dt);
	*/
	// ---- Custom Light Gestures ----
